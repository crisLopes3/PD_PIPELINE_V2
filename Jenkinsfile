    ...
    stages {
        ...
        stage('Run Ansible Playbook') {
            when {
             ...
             steps {
                script {
                    ansiblePlaybook credentialsId: 'ansible-CN', disableHostKeyChecking: true,extras: {{VERSION}}, installation: 'ansible2', inventory: 'hosts.inventory', playbook: 'playbook.yml'
                }
             }
           }  
    }
