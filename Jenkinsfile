    ...
    stages {
        ...
        stage('Run Ansible Playbook') {
            when {
             ...
             steps {
                script {
                    ansiblePlaybook credentialsId: 'ansible-CN', disableHostKeyChecking: true, extras: "-e my_app_version=${params.VERSION}", installation: 'ansible2', inventory: 'hosts.inventory', playbook: 'playbook.yml'
                }
             }
           }  
    }
